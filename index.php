<?php 
	...
	if (isset($_POST['submit'])) {
		...
		$kruiden4 = isset($_POST["kruiden4"]) ? $_POST["kruiden4"] : "";
		$kruiden4 = $kruiden3 =="on" ? "Kruiden4" : "";

		$kruidens =  $kruiden . "," . $kruiden2 . ", " . $kruiden3 . "," . $kruiden4;

		$sql = $conn->prepare('INSERT INTO pizza (bodemformaat, saus, topping, kruiden) VALUES (?,?,?,?)');
		$sql->bind_param('ssss', $formaat, $saus, $toppings, $kruidens);
		$sql->execute();
 	...
 	<div class="center">
 		<div class="col-md-4">
 			<div class="row">
				...
				<div class="form-check">
 					<input class="form-check-input" type="checkbox" name="kruiden4">
					<label class="form-check-label">
					    Zwarte peper
					</label>
				</div>
